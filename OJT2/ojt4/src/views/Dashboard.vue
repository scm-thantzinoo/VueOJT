...
<template>
    <div class="w-screen py-96 flex justify-center items-center">
...
<style scoped>
.link{
    @apply bg-slate-800 text-slate-400 px-8 py-6 rounded-xl shadow-lg cursor-pointer text-2xl hover:text-slate-100 ml-5
}
</style>